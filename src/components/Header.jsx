...
const Header = () => {
  return (
    <header>
    <nav className="flex navbar gap-5 font-sans font-bold">
      <Link className="transition-all ease-in duration-100 hover:ring-4 ring-main-300 contacts mr-auto block border-2 border-main-600 bg-opacity-30 rounded-full text-main-600 m-4 p-2"to="/Contacts">DWT<i class="text-white">web<i class="text-main-600">and</i>graphic</i></Link>
      <label className="switch -translate-y-96 mt-auto mb-auto scale-75">
      ...
      <Link class="home block p-4 -translate-y-96" to="/"><i class="bi bi-house-fill block relative text-3xl text-main-600"></i></Link>
    </nav>
    </header>
  );
};
